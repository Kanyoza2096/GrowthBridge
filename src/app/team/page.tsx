        ...
        <Container size="lg">
          {isError ? (
            ...
            <div className="text-center py-16 rounded-3xl border bg-[var(--surface-soft)] border-[var(--border-subtle)]">
              <div className="w-12 h-12 rounded-full mx-auto grid place-items-center mb-3 text-2xl bg-[var(--chip-orange-bg)] text-[var(--chip-orange-text)]">
                🔍
              </div>
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center space-x-3.5">
            {person.photo ? (
              ...
              <div className="w-14 h-14 rounded-2xl grid place-items-center font-bold text-lg text-white shadow-md bg-[var(--gradient-brand)]">
                {initials}
              </div>
            )}
            <div>
