...
export default function AdminEditPersonPage() {
  ...
  if (isLoading) {
    return (
      <div className="py-20 text-center text-xs text-[var(--admin-text-tertiary)]">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-center">
            ...
            <div className="flex items-center space-x-2 pt-5">
              ...
              />
              <label htmlFor="edit-featured" className="text-xs font-bold text-[var(--admin-text-secondary)] cursor-pointer">
                Featured Profile
              </label>
            </div>
            ...
            <div className="flex items-center space-x-2 pt-5">
              <input
                ...
                className="w-4 h-4 rounded text-emerald-500 bg-[var(--admin-surface-deep)] border-[var(--admin-border)] focus:ring-0"
              />
              <label htmlFor="edit-active" className="text-xs font-bold text-[var(--admin-text-secondary)] cursor-pointer">
                Active Status
              </label>
            </div>
          </div>
