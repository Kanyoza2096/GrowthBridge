        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-center">
            ...
            <div className="flex items-center space-x-2 pt-5">
              ...
              />
              <label htmlFor="featured" className="text-xs font-bold text-slate-300 cursor-pointer">
                Featured Profile
              </label>
            </div>
            ...
            <div className="flex items-center space-x-2 pt-5">
              <input
                ...
                className="w-4 h-4 rounded text-emerald-500 bg-slate-950 border-slate-800 focus:ring-0"
              />
              <label htmlFor="active" className="text-xs font-bold text-slate-300 cursor-pointer">
                Active Status
              </label>
            </div>
          </div>
