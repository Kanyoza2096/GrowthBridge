...
export class PartnersRepository {
  ...
  async update(id: string, updates: Partial<Partner>): Promise<Partner> {
    const supabase = createAdminClient();
    const payload: any = {};
    if (updates.organizationName) payload.organization_name = updates.organizationName;
    ...
    if (updates.partnershipType) payload.partnership_type = updates.partnershipType;
