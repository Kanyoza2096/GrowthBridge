...
const schema = z.object({
  ...
  SOCIAL_FEED_API_URL: z.string().url().optional(),
...
const parsed = schema.safeParse({
  ...
  SOCIAL_FEED_API_URL: process.env.SOCIAL_FEED_API_URL,
...
const dev = {
  ...
  SOCIAL_FEED_API_URL: undefined as string | undefined,
...
export function logServerConfigStatus() {
  ...
  console.info('[ServerConfig] Status:', {
    ...
    social_feed_api: cfg.SOCIAL_FEED_API_URL ? '✓ configured' : 'not configured',
