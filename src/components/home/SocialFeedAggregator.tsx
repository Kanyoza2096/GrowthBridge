...
export function SocialFeedAggregator() {
  ...
  return (
    <section className="py-16 sm:py-20 bg-[var(--surface-soft)] relative overflow-hidden border-t border-b border-[var(--border-subtle)]">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-[var(--gb-green-600)]/10 via-[var(--gb-navy-600)]/5 to-[var(--gb-orange-500)]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8 sm:space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6">
          ...
          >
            <span className={cn('text-base leading-none', isFetching && 'animate-spin')}>🔄</span>
          ...
          {PLATFORM_FILTERS.map((tab) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex items-center gap-2 px-4 py-2.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all border shrink-0 min-h-[40px]',
                  active
