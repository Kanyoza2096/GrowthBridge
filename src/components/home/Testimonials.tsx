...
export function Testimonials() {
  ...
  return (
    <section className="py-20 relative bg-[var(--surface-page)]">
      <Container size="lg">
        <SectionHeading
          badge="Testimonials"
          badgeVariant="green"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials?.map((t, idx) => (
              <ScrollReveal key={t.id} delay={idx * 150}>
                <Card variant="glass" className="h-full flex flex-col justify-between p-6 space-y-4">
                  ...
                  <div className="pt-4 border-t border-[var(--border-subtle)] flex items-center space-x-3">
                    <div className="w-10 h-10 rounded-full bg-[var(--gradient-brand)] flex items-center justify-center font-bold text-white text-sm">
                      {t.author.charAt(0)}
                    </div>
                    <div>
