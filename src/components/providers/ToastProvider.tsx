...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ToastContext.Provider value={{ toast, success, error, info, warning }}>
      ...
      <div
        className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] left-[max(1rem,env(safe-area-inset-left))] right-[max(1rem,env(safe-area-inset-right))] sm:left-auto sm:right-6 sm:bottom-6 z-50 flex flex-col gap-2 w-auto sm:w-full max-w-sm pointer-events-none"
        aria-live="polite"
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="gb-touch-target min-w-9 min-h-9 -mr-1 -mt-1 inline-flex items-center justify-center rounded-lg text-[var(--text-tertiary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-soft)] text-sm flex-shrink-0 cursor-pointer transition-colors duration-150"
