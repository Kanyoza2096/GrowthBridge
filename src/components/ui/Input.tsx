      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative rounded-xl">
          ...
          <input
            ...
            ref={ref}
            className={cn(
              'w-full rounded-xl bg-[var(--form-bg)] border border-[var(--form-border)] text-[var(--form-text)] placeholder-[var(--form-placeholder)] px-4 py-3 text-base sm:text-sm transition-colors duration-200 min-h-11',
