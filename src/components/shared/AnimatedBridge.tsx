...
export function AnimatedBridge({ className }: AnimatedBridgeProps) {
  return (
    <div className={`relative w-full max-w-2xl mx-auto ${className || ''}`} data-motion="signature-bridge">
      <svg
        viewBox="0 0 800 400"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="w-full h-auto drop-shadow-[0_10px_35px_rgba(22,163,106,0.18)]"
        role="img"
      ...
      >
        ...
        {/* Animated Pulsing Tech Nodes — intentional system-status motion */}
        {/* Node 1: Youth/Skills */}
        ...
        <g className="animated-bridge__label" fill="var(--text-secondary)" textAnchor="middle">
          <text x="200" y="180" fontSize="11" fontWeight="600">Youth &amp; Skills</text>
        </g>
        <g className="animated-bridge__label animated-bridge__label--core" fill="var(--text-accent)" textAnchor="middle">
